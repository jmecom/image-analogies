function [ best_i, best_j ] = best_match( A_pyramid_extend, ...
...
[best_app_i, best_app_j] = best_approximate_match(A_features, ...
  B_features, l, i, j);

% TODO: Comment these back in once we do coherence.
